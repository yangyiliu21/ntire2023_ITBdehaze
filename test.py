...
from utils_test import to_psnr,to_ssim_skimage, test_generate, image_stick
...
with torch.no_grad():
    ...
    for batch_idx, (hazy,vertical) in enumerate(val_loader):   
        ...
        if args.cropping == 4:
            ...
            imwrite(img_t, os.path.join(output_dir, str(batch_idx+46)+'.png'))
            ...
            imwrite(img_list[batch_idx], os.path.join(imsave_dir, str(batch_idx + 46)+'.png'))
